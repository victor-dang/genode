...
class Tsc_380 : Genode::Mmio
{
	private:
		...
		struct Sec_inversion  : public Register<0x44, 32>
		{
	...
	public:
		...
		{
			write<Region_attr<REGION0_REG_OFF>::Normal_read>(1);
			write<Region_attr<REGION0_REG_OFF>::Normal_write>(1);
			write<Region_attr<REGION0_REG_OFF>::Secure_read>(1);
			write<Region_attr<REGION0_REG_OFF>::Secure_write>(1);
			write<Region_attr<REGION1_REG_OFF>::Enable>(0);
			write<Region_attr<REGION2_REG_OFF>::Enable>(0);
			write<Region_attr<REGION3_REG_OFF>::Enable>(0);
			write<Region_attr<REGION4_REG_OFF>::Enable>(0);
			write<Region_attr<REGION5_REG_OFF>::Enable>(0);
			write<Region_attr<REGION6_REG_OFF>::Enable>(0);
			write<Region_attr<REGION7_REG_OFF>::Enable>(0);
			write<Region_attr<REGION8_REG_OFF>::Enable>(0);
			write<Region_attr<REGION9_REG_OFF>::Enable>(0);
			write<Region_attr<REGION10_REG_OFF>::Enable>(0);
			write<Region_attr<REGION11_REG_OFF>::Enable>(0);
			write<Region_attr<REGION12_REG_OFF>::Enable>(0);
			write<Region_attr<REGION13_REG_OFF>::Enable>(0);
			write<Region_attr<REGION14_REG_OFF>::Enable>(0);
			write<Region_attr<REGION15_REG_OFF>::Enable>(0);
